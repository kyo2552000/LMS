...
import { Loader2, Eye, EyeOff, Mail, Lock, UserPlus, User } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center py-12 bg-slate-50 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-indigo-400/20 rounded-full blur-[100px] -z-10 mix-blend-multiply" />
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-purple-400/20 rounded-full blur-[100px] -z-10 mix-blend-multiply" />
      ...
      <Card className="w-full max-w-[420px] rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-white/60 bg-white/80 backdrop-blur-xl relative z-10 mx-4">
        <CardHeader className="text-center pb-2 pt-8">
          ...
          <CardDescription className="text-base text-slate-500 mt-2">
            Bắt đầu hành trình học tập cùng EduLearn
          </CardDescription>
        </CardHeader>
            ...
            <div className="flex items-start text-sm pt-2">
              <label className="flex items-start gap-2.5 cursor-pointer group">
                <div className="relative flex items-center justify-center mt-0.5">
                    <input type="checkbox" required className="peer w-4 h-4 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500 cursor-pointer" />
                </div>
